...
#include "Galaga_USFX_L01/InventarioComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	GALAGA_USFX_L01_API UClass* Z_Construct_UClass_UInventarioComponent();
...
// End Cross Module References
	...
	{
		P_GET_OBJECT(AmucionV2,Z_Param_ActorToRemove);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	{
		P_GET_OBJECT(AmucionV2,Z_Param_ActorToAdd);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UInventarioComponent_AddToInventory_Statics::NewProp_ActorToAdd = { "ActorToAdd", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(InventarioComponent_eventAddToInventory_Parms, ActorToAdd), Z_Construct_UClass_AmucionV2_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UInventarioComponent_RemoveFromInventory_Statics::NewProp_ActorToRemove = { "ActorToRemove", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(InventarioComponent_eventRemoveFromInventory_Parms, ActorToRemove), Z_Construct_UClass_AmucionV2_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInventarioComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInventarioComponent_AddToInventory, "AddToInventory" }, // 1664945863
		{ &Z_Construct_UFunction_UInventarioComponent_RemoveFromInventory, "RemoveFromInventory" }, // 2006783171
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UInventarioComponent_Statics::NewProp_CurrentInventory_Inner = { "CurrentInventory", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_AmucionV2_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UInventarioComponent, 3472051610);
	template<> GALAGA_USFX_L01_API UClass* StaticClass<UInventarioComponent>()
	{
		return UInventarioComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UInventarioComponent(Z_Construct_UClass_UInventarioComponent, &UInventarioComponent::StaticClass, TEXT("/Script/Galaga_USFX_L01"), TEXT("UInventarioComponent"), false, nullptr, nullptr, nullptr);
