...
ABall::ABall()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> BallMesh(TEXT("StaticMesh'/Game/StarterContent/Shapes/Shape_Torus.Shape_Torus'"));
	//Segunda forma de crear material
	static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaterialBall(TEXT("StaticMesh'/Game/StarterContent/Shapes/Shape_Torus.Shape_Torus'"));
